    ...
    public static class ModernAlertDialogApp extends Application {
        ...
        public void start(Stage primaryStage) {
            ...
            showAlertButton.setOnAction(e -> {
                ...
                ModernAlertDialog alert = new ModernAlertDialog("Custom Alert", "This is a modern alert with an image!", "/path/to/your/image.png");
                alert.showAndWait();
            });

            root.getChildren().add(showAlertButton);
            Scene scene = new Scene(root, 400, 300);
            scene.getStylesheets().add(getClass().getResource("/res/AlrtStyles.css").toExternalForm());
